        ...
        >
          ...
          {data.data.data.map((Category) => (
            <SwiperSlide key={Category._id}>
              <div className="border  rounded-lg p-2 m-4 md:m-0 md:my-2 hover:scale-105 hover:shadow hover:shadow-primay-200 transition-all duration-75 cursor-pointer  hover:border-primay-200">
